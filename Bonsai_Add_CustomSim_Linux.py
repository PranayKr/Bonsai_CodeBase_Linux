...
import numpy as np
from DeepQN_Agent_Linux import Agent
...
from NN_Model_Linux import DeepQNetModel
...
class TemplateSimulatorSession:
    def __init__(
        ...
        self.env = UnityEnvironment(file_name="sim/Banana_Linux/Banana_Linux/Banana.x86_64")
